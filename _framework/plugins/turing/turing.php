...
class Turning
{
	public static function code($lenght='5',$symbols='',$style='',$distortion='',$kolor='',$rotation='25'){
		# Config
		@error_reporting( 1 );
		...
		/* Set thick colored lines in background.
			...
			1  linear background.  
		*/
		$LinearBackgroud = $style == 'linearBG' ?'1':'0';

		/* Set granular noise.
			0  no granular noise.
			1  granular noise.  
		*/
		$GranularNoise = $style == 'granularNoise' ?'1':'0';
		...
		/* Set linear noise.
			...
			1  square noise.  
		*/
		$LinearNoise = $style == 'linearNoise' ?'1':'0';
		...
		/* Set square noise .
			...
			1  square noise.  
		*/
		$SquareNoise = $style == 'squareNoise' ?'1':'0';

		/* Horizontal Character distortion.
			0  no distortion.
			1  distortion.  
		*/
		$distortion_hor = $distortion == 'hor' ?'1':'0';

		/* Vertical Character distortion.
			0  no distortion.
			1  distortion.  
		*/
		$distortion_ver = $distortion == 'ver' ?'1':'0';
		
		/* Character color select.
			0  All characters are black.
			1  random color.  
		*/
		$CharacterColorMode = $kolor == 'rand' ?'1':'0';
		...
		*/
		...
		/* Character rotation angle. The script will randomize the rotation of the
		   ...
		   20 rotation of 20°
		   */
		$CharacterRotationMode = $rotation;
		...
		*/
		...
		$fontlist = array($fontpath.'PlayfairDisplay-Regular.otf',$fontpath.'Lato-Regular.ttf');
		...
		$Characters = $symbols == '1'?'#123456789?qwertyuiopasdfghjklzxcvbnm@':'123456789qwertyuiopasdfghjklzxcvbnm';
