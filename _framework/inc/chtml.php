...
final class CHtml
{
	...
	public static function printFrame($path){
		return '<iframe allowtransparency="1" frameborder="0" src="'.$path.'" id="printframe" name="printframe" style="border-radius:4px;width:100%; height:500px; border:1px #000000 solid; padding:20px 0px 30px 10px;"></iframe>';
	}
