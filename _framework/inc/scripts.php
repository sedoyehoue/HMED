...
if($.isFunction($.fn.datepicker)){
	$('.datepicker').attr('readonly',true).attr('placeholder','YYYY-MM-DD');
	$('.monthpicker').attr('readonly',true).attr('placeholder','YYYY-MM');
    $('.yearpicker').attr('readonly',true).attr('placeholder','YYYY');
